...
try:
    ...
    raise RuntimeError(
        "ckanext-user_ext must be installed before this plugin.")
...
setup(
    ...
    description='''This plugin adds a popup that asks a new user if they wish
    to opt-in to the research component of the Land and Water DAR.''',
    ...
    # Choose your license
    license='AGPL',  # Cannot change this!
    ...
    keywords='''CKAN User Opt In plugin table''',
    ...
    entry_points='''
        [ckan.plugins]
        user_opt_in=ckanext.user_opt_in.plugin:UserOptInPlugin
